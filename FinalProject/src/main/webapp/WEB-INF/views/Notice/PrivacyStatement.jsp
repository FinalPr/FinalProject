...
<head>
<meta charset="UTF-8">
 <link rel="stylesheet" href="/spring/resources/assets/css/PrivacyStatement.css"/>
  <script src="http://code.jquery.com/jquery-3.5.1.min.js"></script>
</head>
<body>
 <!-- 이용약관 시작-->
  	<%@ include file="../common/header.jsp"%>
    <div class="PrivacyStatementDiv">
        <h3 class="PrivacyStatementTitle"><b>PrivacyStatement</b></h3>
    </div>

    <div class="PrivacyStatementPrecautions">
        <p class="PrivacyStatement"> 
            <b>인터넷 쇼핑몰『 오ㅇ!마켓 사이버 몰』회원 약관</b>
            <br><br>
            <b>제1조(목적)</b><br><br>
            이 약관은 러브패리스 회사(전자상거래 사업자)가 운영하는 러브패리스 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
            
            * PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.  
             
            <br><br>
            <b>제2조(정의)</b><br><br>
            ①"몰" 이란 러브패리스 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
            ②"이용자"란 "몰"에 접속하여 이 약관에 따라 "몰"이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
            ③ '회원'이라 함은 "몰"에 개인정보를 제공하여 회원등록을 한 자로서, "몰"의 정보를 지속적으로 제공받으며, "몰"이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
            ④ '비회원'이라 함은 회원에 가입하지 않고 "몰"이 제공하는 서비스를 이용하는 자를 말합니다.
             
            <br><br>
            <b>제3조 (약관등의 명시와 설명 및 개정)</b><br><br>
            ...
            몰이용자는 "몰"상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, "몰"은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.  
            ...
            다만 "몰"이 고의과실이 없음을 입증한 경우에는 그러하지 아니합니다.
             
            <br><br>
            <b>제14조(환급)</b><br><br>
            "몰"은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게 통지하고
            ...
            <b>제 18조 (적립금제도 등 운영)</b><br><br>
             
            ①적립금의 취득  
            "몰"은 회원이 상품을 구매하거나"몰"의 이벤트, 후기글 작성 등을 통하여 이용자에게 적립금취득 기회를 부여합니다.  
            <br><br>
            ②적립금의 사용  
            1.취득한 적립금은 해당 "몰"에서만 사용이 가능하며 구매금액 '30,000' 이상 결제시 1원부터 사용가능합니다.
            <br><br>
            2.적립금은 타 결제수단(신용카드,모바일,현금)과 함께 사용될수 있습니다.  
            단 2가지 방법의 한에서 복합결제 가능합니다.
            <br><br>
            ③적립금의 소멸  
            "몰"로부터 제공받은 적립금의 경우 회사가 별도로 유효기간을 정한 때에는 이에 따릅니다.  
            유효기간이 경과한 적립금은 자동으로 소멸하게 되며, 다음의 경우 적립금이 소멸 됩니다.  
            <br><br>
            1.적립금 소멸은 매년 1월 1일 부터 12월 31 일까지 적립된 적립금을 다음해 12월31일에 자동으로 소멸됩니다.  
            유효기간내에 사용되지 않은 적립금은 기간만료시 자동 소멸 됩니다.
            <br><br>
            2.회원을 탈퇴한 경우 자동소멸 됩니다.
            <br><br>
            3.적립금을 이용하여 부당 이득을 취하거나 악의적인 상거래가 발생할경우,  
            회원탈퇴 또는 해당 적립금의 지급을 중지 또는 환수 할수 있습니다.  
             
             
            <br><br>
            <b>제19조("몰"의 의무)</b><br><br>
            ...
            <b>제20조(회원의 ID 및 비밀번호에 대한 의무)</b><br><br>
            ① 제17조의 경우를 제외한 ID와 비밀번호에 관한 관리책임은 회원에게 있습니다.
            ② 회원은 자신의 ID 및 비밀번호를 제3자에게 이용하게 해서는 안됩니다.
            ③ 회원이 자신의 ID 및 비밀번호를 도난당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로 "몰"에 통보하고 "몰"의 안내가 있는 경우에는 그에 따라야 합니다.
             
            <br><br>
            <b>제21조(이용자의 의무)</b><br><br>
            ...
            <br><br>
            <b>제22조(연결"몰"과 피연결"몰" 간의 관계)</b><br><br>
            ...
            <br><br>
            부 칙(시행일) 이 약관은 2008년 02월 01일부터 시행합니다.
            
            <br><br>
            <b>제26조(카카오 알림톡 시행에 관한 내용)</b><br><br>
          
            “러브패리스 쇼핑몰”은 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.
            
            <br><br>
            # 카카오톡 상담톡 시행에 관한 내용
            <br><br>
            "러브패리스 쇼핑몰"은 상담업무를 카카오톡 상담톡으로 진행하며, 만약 카카오톡을 통해 안내되는 상담 내용을 Wi-Fi 나 PC가 아닌 이동통신망으로 이용할 경우, 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 상담을 원치 않으실 경우 고객센터, 게시판 문의를 이용해 주시기 바랍니다.
        </p>
    </div>
        <!-- Gallery End-->
