                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="gender" >
                                ...
                                <input type="radio" name="gender" value="F" checked><span>여</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="birthdd"  class="birthdd"maxlength="2" placeholder="일" size="4" >
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="email" class="email" maxlength="30"><span>@</span>
                        ...
                        <tr>
                            <td id="title">우편번호</td>
                            <td>
                                <input type="text" class="Zipcode" id="sample6_postcode" name="postCode" placeholder="우편번호" >
                                <button type="button" class="addressSearch"value="우편번호 찾기&nbsp;"  onclick="sample6_execDaumPostcode()">주소검색</button>
                            </td>
                        </tr>
                        <tr>
                            <td id="title">주소</td>
                            <td>
                                <input type="text" class="address"  id="sample6_address" name="roadAddress"  placeholder="도로명주소"  readonly />
                            </td>
                        </tr>
                        <tr>
                            <td id="title">상세</td>
                            <td>
                                <input type="text" class="Detail" id="sample6_address2" name="detailAddress"  placeholder="상세주소" />
                            </td>
                        </tr>
                    ...
                    <tr>
                        <th class="left">
                                ...
                                <td class="agreeArea">
                                    ...
                                    이 약관은 (주)메이크엠 (전자상거래 사업자)가 운영하는 오ㅇ!마켓 (이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.
                
                                    ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」
                                    <br><br>
                                    제2조(정의)
                
                                    ①“몰” 이란 (주)메이크엠 (전자상거래 사업자)가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                                    ...
                                    ⑤ ‘적립금’이란 “몰”의 이용촉진을 위하여 회원이 상품을 구매하거나 이벤트/프로모션등에 참여한 경우, 회사가 정한 기준에 따라 회원에게 임의로 부여하는 포인트입니다.
                
                                    ⑥ ‘예치금’이란 주문취소 등의 결제대금환불, 초과입금 차액 환불 등으로 발생하는 금액을 고객의 요청에 따라 “몰”에 예치하여 현금대신 사용가능 한 결제수단으로 이자가 발생하지 않는 금원을 말합니다.
                                    <br><br>
                                    ...
                                    ① 적립금 지급의 기준 및 적립비율은 회사의 정책상 언제든지 변경할 수 있으며, 변경된 내용은 “몰”을 통해 고지함으로써 그 효력이 발생합니다.
                
                                    ② 적립금은 제 2조⑤항과 같이 회사에서 임의로 지급해드리는 포인트이기 때문에 현금으로 반환되지 않습니다. 주문 취소한 금액을 “몰”에 예치하시길 원하시는 경우 환불수단을 “예치금”해주시기 바랍니다.
                
                                    ③ 적립금은 주문금액의 할인금액으로 사용이 가능하며, 신용카드, 무통장, 에스크로, 휴대폰결제수단과 함께 사용이 가능합니다. 단, 예치금 및 쿠폰 사용시 적립금 동시사용은 불가합니다.
                
                                    ④ 적립금으로 전액 결제 시 구매적립금은 지급하지 않습니다.
                
                                    ⑤ 적립금 사용의 기준은 “몰”의 사이트 하단 ‘이용안내>기타안내’에 자세히 안내되어 있습니다. (교환/반품 배송비로 대체 불가합니다)
                
                                    ⑥ 적립금은 타인에게 양도가 불가하며, 동일한 회원이 여러개의 아이디(ID)를 보유하더라도 합산할 수 없습니다.
                
                                    <br><br>
                                    제 26조 (적립금 사용기간 및 소멸)
                
                
                                    회원님께 부여된 적립금은 부여 받은 날로부터 1년 이내에 사용해야 하며, 다음의 경우 적립금이 소멸됩니다.
                
                                    ① 적립금을 부여 받은 날로부터 1년간 사용하지 않은 경우 자동소멸.
                
                                    ② 회원을 탈퇴한 경우
                
                                    ③ 적립금 사용가능 조건이 및 소멸에 대한 내용이 변경되어 미리 공지된 경우
                
                                    ④ 적립금을 이용하여 부당이득을 취하거나, 악의적인 상거래가 발생될 경우  “몰”은 해당 적립금의 지급을 중지 또는 회원탈퇴, 기존 적립금 환수 등의 조치를 취할 수 있습니다.
                
                                    ⑤ 주문취소 후, 적립금으로 환불 받은 금액은 사용기한 제한이 없는 예치금으로 언제든지 전환신청이 가능하며, 만약 시스템에 의해 자동소멸 되더라도 고객센터에 문의하시면 확인 후, 적립금환불 받은 금액만큼 예치금으로 전환(복구)시켜 드립니다.
                
                                    <br><br>
                                    제27조 (예치금제도 및 운용)
                
                                    ① ‘예치금’은 상품주문/결제 시 현금과 동일하게 사용이 가능합니다.
                
                                    (예치금은 고객의 현금을 임시 저장하는 수단)
                
                                    ② 고객이 예치금을 사용할 경우 사용기간이나 금액 제한 없이 사용가능 합니다. (교환/반품의 택배비로 대체가능)
                
                                    ③ 기존에 환불금액을 ‘적립금’으로 환불 받았던 고객은 예치금으로 전환 지급을 요청할 수 있습니다.
                
                                    ④ 본래, 현금성거래인 무통장결제만 예치금처리가 가능하나, 고객의 편의를위해 카드결제, 휴대폰결제도 요청하는경우 예치금으로 처리해드리고있습니다. (고객의 요청에의한 예치금처리후 복원불가능함)
                
                                    ⑤ 주문취소 시 결제에 사용한 예치금은 자동으로 반환(복구)됩니다.
                
                                    ⑥ 예치금은 타인에게 양도가 불가하며, 동일한 회원이 여러 개의 아이디(ID)를 보유하더라도 합산할 수 없습니다.
                                ...
                                <td class="AGREEMENTLEFTCHECK">
                                 <p >
                                 <span class="Consentcheck">이용약관에 동의하시겠습니까?</span>
                                 <input type="checkbox" id="agree_service_check0" fw-filter="/1/" fw-label="이용약관 동의" 
                                 fw-msg="이용약관에 동의 하세요" value="1" class="ConsentcheckBox" >
                                 <label for="agree_service_check0" class="Consent">동의함</label>
                                 </p>
                                </td>
                         </th>
                    <th class="rigth">
                        ...
                        다음과 같이 거래 관련 권리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할 필요가 있을 경우에는 그 기간동안 보유합니다.
                     ...
                     <br><br>
                        ...
                        <td class="PrivacycheckRigthCheck">
                            <p>
                             <span class="Privacycheck">개인정보 수집 및 이용에 동의하십니까?</span>
                                 <input type="checkbox" id="agree_service_check1" fw-filter="/2/" fw-label="이용약관 동의" 
                                      fw-msg="이용약관에 동의 하세요" value="2" class="PrivacycheckBox" >
                                 <label for="agree_service_check1" class="Privacy">동의함</label>
                            </p>
                       </td>
                    </th>
                </tr>
