...
<link rel="stylesheet"
	href="/spring/resources/assets/css/fontawesome-all.min.css?aftasder">
						...
						<div class="login_part_form_iner">
							...
							<c:if test="${empty sessionScope.loginUser }">
								<form class="row contact_form" action="login.do"
									id="add_member_form" name="add_member_form" method="post"
									novalidate="novalidate">
									<div class="col-md-12 form-group p_star">
										<input type="text" class="form-control" id="id" name="id"
											value="" placeholder="Id" /> <input type="hidden"
											name="idDuplicateCheck" id="idDuplicateCheck" value="0">
									</div>
									<div class="col-md-12 form-group p_star pwdTest">
									...
									<i class="fas fa-eye" id="eye"></i>
											 ...
											 <input
											type="hidden" name="pwdDuplicateCheck" id="pwdDuplicateCheck"
											value="0">
									</div>
									...
									&response_type=code">
									<input type="hidden" name="kakapopwd" value="${ userInfo.id }">
										...
										<button type="button" class="g_recaptchaBtn" id="edit"
											value="true">
